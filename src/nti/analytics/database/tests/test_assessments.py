...
def _get_history_item():
	...
	#qs_submission = QuestionSetSubmission(questionSetId=_question_set_id, questions=(question_set,))
	qs_submission = QuestionSetSubmission(questionSetId=_question_set_id, questions=(QuestionSubmission(questionId=_question_id, parts=(_response,)),))
...
class TestAssignments(AnalyticsTestBase):
	...
	def test_assignments(self):
		...
		assert_that( assignment_taken.submission_id, is_( 102 ) )
