...
from nti.analytics.database.lti import get_launch_records_by_user
...
def launch_record(username, timestamp=None, resource_id=None, time_length=None):
	return LTIAssetLaunches(user_id=username, resource_id=resource_id, timestamp=timestamp, time_length=time_length)
